...
class NivelDos(Nivel):
    def __init__ (self,pantalla:pygame.Surface):
        ...
        #FONDO
        fondo = pygame.image.load(r"texturas\Mapas\Pantalla\lvl_2.png").convert()
        ...
        moneda1 = Moneda((27, 27), 50, (480, 530), coin)
        moneda2 = Moneda((27, 27), 50, (590, 530), coin)
        moneda3 = Moneda((27, 27), 50, (955, 555), coin)
        moneda4 = Moneda((27, 27), 50, (700, 335), coin)
        moneda5 = Moneda((27, 27), 50, (900, 335), coin)
        moneda6 = Moneda((27, 27), 50, (700, 530), coin)
        moneda7 = Moneda((27, 27), 50, (160, 150), coin)
        moneda8 = Moneda((27, 27), 50, (245, 150), coin)
        moneda9 = Moneda((27, 27), 50, (200, 480), coin)
        moneda10 = Moneda((27, 27), 50, (920, 555), coin)
